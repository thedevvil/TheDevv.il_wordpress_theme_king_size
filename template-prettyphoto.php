      					...
      					<div id="gallery_prettyphoto" class="gallery">
    					   <ul class="gallery_<?php echo $no_of_page_columns;?>">							
							<?php 
								...
								?>
									<li><a href="<?php echo wp_get_attachment_url($attachment->ID);?>" class="image" title="<?php echo $post_title;?>" rel="prettyPhoto[gallery]"><img  src="<?php echo $url_post_img;?>" alt="<?php echo $attachment->post_title;?>" title="<?php echo $attachment->post_title;?>"/></a></li>									
							<?php
								   }
								}
							?>								
